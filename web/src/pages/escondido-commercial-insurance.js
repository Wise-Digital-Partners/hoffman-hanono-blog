  ...
  return (
    <Layout>
      <SearchEngineOptimization
        title="Escondido Commercial Insurance | Hoffman Hanono"
        description="Need commercial insurance for your Escondido business? Get a free quote with the experts at Hoffman Hanono Insurance today!"
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-y-8 md:gap-y-0 items-center">
            ...
            <div className="md:col-end-13 md:col-span-4">
              ...
              <p>
                ...
                solutions for Escondido business owners. With years of
      ...
      <section className="wrapper">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            ...
            <div>
              <h2>Why We Love Escondido</h2>
              <p className="mb-0">
                Escondido is the largest city in North County San Diego, and
                we’re proud to provide insurance to those who live, work, and
                own businesses there. The city is one of those places with a
                little bit of something for everyone. There’s warm weather for
                sun lovers, distinct craft breweries and wineries for beer and
                wine enthusiasts, lots of space for outdoor enthusiasts at Daley
                Ranch and Dixon Lake, and the San Diego Zoo Safari Park. And
                when you want cool ocean breezes and sand on your toes, you’re
                just 15 minutes from the beach. We love all that Escondido
                brings to the greater San Diego area.
              </p>
            </div>
          </div>
        </div>
...
export const query = graphql`
  {
    ...
    city: file(relativePath: { eq: "city/Escondido.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 568) {
          ...GatsbyImageSharpFluid_withWebp
        }
