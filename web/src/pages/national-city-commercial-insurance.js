  ...
  return (
    <Layout>
      <SearchEngineOptimization
        title="National City Commercial Insurance | Hoffman Hanono"
        description="Get a quote with the experts at Hoffman Hanono to find the best commercial insurance policy for your business. Contact us today!"
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-y-8 md:gap-y-0 items-center">
            ...
            <div className="md:col-end-13 md:col-span-4">
              ...
              <p>
                ...
                solutions for National City business owners. With years of
      ...
      <section className="wrapper">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            ...
            <div>
              <h2>Why We Love National City</h2>
              <p className="mb-0">
                Visit one of San Diego’s oldest communities—National City!
                Locals and visitors alike can enjoy the city’s historical
                landmarks like Granger Music Hall and Brick Row on Heritage
                Square, its 87.2 acres of park land, and its diverse dining &
                shopping experiences. For the golfers out there, National City
                Golf Course offers discounts to residents and budget-friendly
                rounds for visitors. Visit the marina for some fresh seafood,
                take a day trip to Mexico, or take advantage of the many
                recreational opportunities available year-round. As San Diego’s
                Gateway, find your next adventure in this rich and historic
                city.
              </p>
            </div>
          </div>
...
export const query = graphql`
  {
    ...
    city: file(relativePath: { eq: "city/National City.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 568) {
          ...GatsbyImageSharpFluid_withWebp
        }
